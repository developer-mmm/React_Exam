  ...
  return (
    <header className="bg-base-200 text-base-content rounded mb-10 ">
      <nav className="flex justify-between items-center">
        <div className="left">
          <NavLink to="/">
            <button className="btn btn-secondary">MyStore</button>
          </NavLink>
        </div>
        ...
        <div className="right flex items-center gap-6">
          ...
          <div className="dropdown relative">
            <button
              onClick={logOut}
              className="btn focus:btn-outline normal-case ml-2"
            >
              {" "}
              {/* Added onClick event for logOut */}
